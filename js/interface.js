...
(function() {
  ...
  window.onload = function() {
    var box, canvas, input, range, _i, _j, _len, _len1, _ref, _ref1;
    ...
    _ref = $('#panel input[type=checkbox]');
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      box = _ref[_i];
      $(box).bind('change', function(e) {
        var i, n, value, _j, _len1, _ref1, _ref2, _results;
        value = parseInt(this.value);
        if (this.checked) {
          if (_ref1 = this.value, __indexOf.call(game.soul[this.name], _ref1) < 0) {
            return game.soul[this.name].push(value);
          }
        } else {
          _ref2 = game.soul[this.name];
          _results = [];
          for (i = _j = 0, _len1 = _ref2.length; _j < _len1; i = ++_j) {
            n = _ref2[i];
            if (n === value) {
              _results.push(game.soul[this.name].splice(i, 1));
            } else {
    ...
    _ref1 = $("#panel input[type=range]");
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      range = _ref1[_j];
      $(range).bind('change', function(e) {
        game[this.dataset["var"]] = parseInt(this.value);
